...
(ns
    ...
    nilern.cljs.algo.generic.collection
...
(defmethod assoc :default
           [map & key-val-pairs]
  (apply cljs.core/assoc map key-val-pairs))
...
(defmethod dissoc :default
           [map & keys]
  (apply cljs.core/dissoc map keys))
...
(defmethod get :default
           ([coll key]
            (cljs.core/get coll key))
  ([coll key not-found]
   (cljs.core/get coll key not-found)))
